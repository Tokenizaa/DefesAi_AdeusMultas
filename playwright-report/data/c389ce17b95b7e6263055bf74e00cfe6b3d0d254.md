...
- Name: onboarding.spec.ts >> Onboarding Flow - E2E >> admin-buttons: admin sees test-fill buttons on steps 4, 5 and 8
- Location: tests/onboarding.spec.ts:192:1
...
- main:
  ...
  - button "🧪 Preencher com dados de teste"
