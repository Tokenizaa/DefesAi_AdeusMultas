...
- Name: onboarding.spec.ts >> Onboarding Flow - E2E >> validation: required fields block advancing past step 4
- Location: tests/onboarding.spec.ts:254:3
...
- main:
  ...
  - heading "1. Situação que deseja resolver" [level=2]
  - text: Passo 1 de 4 • Situação
  - heading "Qual situação você quer resolver?" [level=1]
  - paragraph: Escolha o tipo de infração para aplicarmos as defesas adequadas.
  - button "Multa de Trânsito Radar, celular ao volante, sinal vermelho, estacionamento, rodízio ou infrações gerais. Análise Gratuita Continuar":
    - heading "Multa de Trânsito" [level=3]
    - paragraph: Radar, celular ao volante, sinal vermelho, estacionamento, rodízio ou infrações gerais.
    - text: Análise Gratuita Continuar
  - button "Conversão em Advertência (0 Reais de Multa) Art. 267 do CTB (Lei 14.071/20). Isenção total de pagamento e 0 pontos na CNH para infrações leves ou médias. 100% Isenção Continuar":
    - heading "Conversão em Advertência (0 Reais de Multa)" [level=3]
    - paragraph: Art. 267 do CTB (Lei 14.071/20). Isenção total de pagamento e 0 pontos na CNH para infrações leves ou médias.
    - text: 100% Isenção Continuar
  - button "Indicação de Real Condutor Transferência legal da pontuação para o motorista que estava dirigindo o veículo no momento da infração. Art. 257 § 7º Continuar":
    - heading "Indicação de Real Condutor" [level=3]
    - paragraph: Transferência legal da pontuação para o motorista que estava dirigindo o veículo no momento da infração.
    - text: Art. 257 § 7º Continuar
  - button "Suspensão da CNH / Lei Seca Processo de suspensão por bafômetro (Art. 165/165-A), excesso de velocidade acima de 50% ou acúmulo de pontos. Proteção CNH Continuar":
    - heading "Suspensão da CNH / Lei Seca" [level=3]
    - paragraph: Processo de suspensão por bafômetro (Art. 165/165-A), excesso de velocidade acima de 50% ou acúmulo de pontos.
    - text: Proteção CNH Continuar
  - button "Cassação da CNH (PCDD) Defesa contra processo de cancelamento do direito de dirigir por conduzir com CNH suspensa ou reincidência. Instância Crítica Continuar":
    - heading "Cassação da CNH (PCDD)" [level=3]
    - paragraph: Defesa contra processo de cancelamento do direito de dirigir por conduzir com CNH suspensa ou reincidência.
    - text: Instância Crítica Continuar
  - text: Sem necessidade de cadastro prévio Cálculo determinístico de prazos Base jurídica atualizada com a Lei 14.071/20
- contentinfo:
