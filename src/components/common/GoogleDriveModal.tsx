        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          {!isAuthenticated ? (
            <div className="py-8 px-4 text-center max-w-md mx-auto space-y-5">
              ...
              {authError && (
                <div className="p-3 bg-rose-50 border border-rose-200 rounded-xl flex items-center gap-2 text-rose-700 text-xs text-left">
            ...
            <>
              ...
              <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  {quota && (
                    <span className="hidden sm:inline-block text-[11px] text-slate-500 font-mono bg-white px-2.5 py-1 rounded-lg border border-slate-200">
                ...
                <div className="p-4 bg-orange-50/80 border border-orange-200 rounded-2xl space-y-3">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    <button
                      ...
                      className="px-4 py-2 bg-orange-600 hover:bg-orange-500 text-white rounded-xl text-xs font-bold flex items-center gap-2 shadow-xs transition-colors cursor-pointer disabled:opacity-50"
                    >
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-orange-500/20"
                  />
                </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5 max-w-sm w-full space-y-4 shadow-2xl">
            <div className="flex items-center gap-3 text-rose-600">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Confirmação obrigatória</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                ...
                disabled={isDeleting}
                className="px-3 py-1.5 text-xs font-bold bg-rose-600 hover:bg-rose-500 text-white rounded-xl transition-colors cursor-pointer disabled:opacity-50"
              >
