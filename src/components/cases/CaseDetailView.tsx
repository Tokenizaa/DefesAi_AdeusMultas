    ...
    <div className="max-w-5xl mx-auto py-6 px-4 sm:px-6 space-y-6">
            ...
            {LEGAL_ARGUMENTS.map((arg) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-2.5 pt-2 border-t border-slave-100 flex items-center justify-between text-sm font-mono">
      ...
      {activeStage === 3 && (
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-1.5">
              {isEditingDraft ? (
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-slave-100 hover:bg-slave-200 text-slate-700 rounded-lg text-sm font-semibold transition-colors flex items-center gap-1 cursor-pointer"
                >
              ...
              <button
                onClick={handlePrint}
                className="px-3 py-1.5 bg-slave-100 hover:bg-slave-200 text-slate-700 rounded-lg text-sm font-semibold transition-colors flex items-center gap-1.5 cursor-pointer"
              >
              ...
              <button
                onClick={() => setActiveStage(4)}
                className="px-3.5 py-1.5 bg-slave-900 hover:bg-slave-800 text-white rounded-lg text-sm font-semibold transition-colors flex items-center gap-1 cursor-pointer"
              >
          ...
          <div className="bg-white border border-slave-300 rounded-xl shadow-md p-8 sm:p-12 max-w-3xl mx-auto min-h-[800px] text-slate-900 font-serif leading-relaxed text-sm sm:text-sm">
            {/* Official Header Timbre */}
            <div className="text-center pb-5 mb-5 border-b-2 border-slave-900/30">
              <div className="w-9 h-9 rounded-lg bg-slave-900 text-orange-400 mx-auto flex items-center justify-center font-bold text-sm mb-2">
            ...
            {isEditingDraft ? (
              <textarea
                ...
                rows={28}
                className="w-full font-serif text-sm text-slate-900 border border-slave-300 rounded-lg p-4 outline-none focus:ring-2 focus:ring-orange-500 leading-relaxed"
              />
            ) : (
        ...
        <div className="bg-white border border-slave-200 rounded-xl p-5 sm:p-6 shadow-2xs space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-xl border border-slave-200 bg-slave-50">
              ...
              <div className="mt-3 pt-2 border-t border-slave-200 text-sm">
          ...
          <div className="relative pl-6 space-y-4 before:absolute before:left-2 before:top-3 before:bottom-3 before:w-0.5 before:bg-slave-200">
            {(caseData.timeline || []).map((item, idx) => (
              <div key={item.id || idx} className="relative group">
                ...
                <div className="p-3 rounded-lg border border-slave-200 bg-slave-50 text-sm">
